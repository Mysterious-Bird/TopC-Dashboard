...
MEMBERS = [
    # (name, gender, phone, qq, email, [roles], enroll_year, major, student_id, tags, joined_at, color)
    ('林亦风', '男', '138****2201', '821034556', 'linyf@topc.dev', ['社长'], 2023, '计算机科学与技术', '2023****01', '全栈,Rust,架构', '2023-09-01', '#22d3ee'),
    ('苏晚星', '女', '137****8842', '790123884', 'suwx@topc.dev', ['副社长', 'TC部成员'], 2023, '软件工程', '2023****02', '算法,C++,竞赛', '2023-09-01', '#a78bfa'),
    ('赵擎苍', '男', '139****9024', '417766230', 'zhaoqc@topc.dev', ['监察部部长', 'AC部成员'], 2024, '网络空间安全', '2024****05', 'CTF,Pwn,逆向', '2024-09-02', '#f87171'),
    ('许青梧', '女', '188****5567', '552019376', 'xuqw@topc.dev', ['AC部部长'], 2024, '人工智能', '2024****04', 'DP,图论,Python', '2024-09-02', '#fbbf24'),
    ('顾清让', '女', '136****7743', '905512847', 'guqr@topc.dev', ['设计部部长'], 2024, '数字媒体技术', '2024****06', '设计,视频,运营', '2024-09-02', '#f472b6'),
    ('陈砚舟', '男', '150****3310', '630288145', 'chenyz@topc.dev', ['TC部成员'], 2024, '计算机科学与技术', '2024****03', '前端,React,Three.js', '2024-09-02', '#34d399'),
    ('何思源', '男', '155****4419', '308844961', 'hesy@topc.dev', ['TC部成员'], 2025, '计算机科学与技术', '2025****07', 'Go,后端', '2025-09-01', '#38bdf8'),
    ('沈知夏', '女', '152****6680', '223019458', 'shenzx@topc.dev', ['AC部成员'], 2025, '软件工程', '2025****08', 'Vue,TypeScript', '2025-09-01', '#4ade80'),
    ('韩景行', '男', '187****2255', '774120693', 'hanjx@topc.dev', ['AC部成员'], 2025, '人工智能', '2025****09', '数论,组合数学', '2025-09-01', '#facc15'),
    ('唐雨桐', '女', '135****8874', '661337209', 'tangyt@topc.dev', ['设计部成员'], 2025, '数据科学', '2025****10', '机器学习,PyTorch', '2025-09-01', '#c084fc'),
    ('罗亦凡', '男', '186****1102', '149885730', 'luoyf@topc.dev', ['AC部成员'], 2024, '网络空间安全', '2024****11', 'Web安全,渗透', '2024-09-02', '#fb923c'),
    ('纪云舒', '女', '158****3346', '330671284', 'jiys@topc.dev', ['AC部成员'], 2024, '信息安全', '2024****12', 'Crypto,Misc', '2024-09-02', '#2dd4bf'),
    ('温以凡', '男', '177****9921', '518203947', 'wenyf@topc.dev', ['设计部成员'], 2025, '数字媒体技术', '2025****13', '摄影,剪辑', '2025-09-01', '#e879f9'),
    ('白露白', '女', '133****5578', '882914630', '', ['设计部成员'], 2025, '视觉传达', '2025****14', '海报,UI', '2025-09-01', '#93c5fd'),
]
...
def main() -> None:
    ...
    with SessionLocal() as db:
        ...
        members: list[Member] = []
        for row in MEMBERS:
            (name, gender, phone, qq, email, role_names, enroll_year, major, sid, tags, joined, color) = row
            m = Member(
                name=name, gender=gender, phone=phone, qq=qq, email=email,
                enroll_year=enroll_year, major=major, student_id=sid, tags=tags,
